...
# import numpy as np
#
# ds = ta.datasets.LIBRISPEECH("data", url='train-clean-100', download=False)
# mfcc = ta.transforms.MFCC(melkwargs={ 'n_fft' : 320 } )
# mfcc_vector = map(lambda x:  mfcc.forward(waveform=x[0]), ds)
# for d in mfcc_vector:
#     print(d.size())
"""Train the model"""
...
# parser.add_argument('--data_dir', default='data/basic',
#                     help="Directory containing the json for getting parameters of the data")
